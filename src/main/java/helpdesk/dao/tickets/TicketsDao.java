...
public class TicketsDao {
	...
	public List<Map<String, Object>> retrieveTicketsData(int loginId){
		String query = "select ticketId,ticketNumber, category, subcategory, description, stat, comments,userName from tickets where login_loginId=?";
